function y=ct_fuse(I1,I2,nlevels)
%    NSCT
%    Input:
%    I1 - input image A
%    I2 - input image B
...
I1=double(I1);
I2=double(I2);
coeffs_1 = pdfbdec( I1, pfilter, dfilter, nlevels );
coeffs_2 = pdfbdec( I2, pfilter, dfilter, nlevels );
...
y = pdfbrec( coeffs, pfilter, dfilter ) ;
